            ...
            <Card className="shadow border-0">
              <CardBody className="px-lg-5 py-lg-5">
                <div className="text-center">
                  ...
                  <h2 className="mb-3" style={{ textTransform: 'uppercase', fontWeight: 'bold', color: 'red' }}>{title}</h2>
                  
                  <Alert color="black" className="text-left">
                  ...
                  <div className="mt-4">
                    <h5 className="text-muted mb-3"><big>What can you do?</big></h5>
