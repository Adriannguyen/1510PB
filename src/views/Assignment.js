...
const Assignment = () => {
  ...
  const handleEditUser = (user) => {
    ...
    const formData = {
      ...
      password: user.plainPassword || "", // Show existing password for admin
  ...
  const handleResetPassword = async (user) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/users/by-id/${user.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      <CardHeader className="border-0">
        <Row className="align-items-center">
          <div className="col">
            ...
            <p className="text-muted mb-0">Create new Group mails</p>
          </div>
          <div className="col text-right">
            <Button
              color="primary"
  ...
  const renderAddPicTab = () => (
    <Card className="shadow">
      <CardHeader className="border-0">
        <Row className="align-items-center">
          <div className="col">
            <h3 className="mb-0">PICs Management</h3>
                  ...
                  <FormGroup>
                    ...
                    <div className="input-group">
                      <Input
                        ...
                        placeholder={
                          editingUser
                            ? "Modify password or leave as is"
                            : "Enter password"
                        }
            ...
            {resetPasswordUser && (
              <div>
                ...
                <Alert color="warning" className="mt-4 mb-0">
                  ...
                  <strong>Important:</strong> Please copy this password and send
                  it to the user securely. This is the only time it will be
